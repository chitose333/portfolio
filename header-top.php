...
<head>
  ...
  <link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Julius+Sans+One&family=Noto+Sans+JP:wght@300;400;500&family=Poiret+One&display=swap" rel="stylesheet">
  <!--Swiper-->
  <!-- <link
  rel="stylesheet"
    ...
    <div class="header__inner inner">
      <div class="header__left">
        <a class="header__logo" href="#">
          ...
          <img src="<?php echo get_template_directory_uri() ?>/images/common/logo.jpg" alt="ロゴ">
        </a>
      </div>
